...
namespace engine {
    ...
    /*
     * Takes floating point values and converts them into unsigned 8-bit integers.
     * Returns: A Pixel object with float values converted to ints.
     */
    ...
    /*
     * Performs a linear interpolation between two Pixel objects.
     * Returns: New Pixel object that is a blend of pixel1 and pixel2.
     * (if t=0 the returned pixel is pixel1, if t=1 the returned pixel is pixel2)
     */
...
#include "engine/application/emscripten.h"

#endif // headless

#include "engine/application/engine_conf.h"
