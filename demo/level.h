        ...
        for (int y = 0; y < height; y+=2) {
			for (int x = 0; x < width; x+=2) {
                ...
                if(noise < 0.25f) {
                    ...
                    world[x][y]     = new Tile("demo/resources/", engine::int_vector_2d(x*8, y*8), true, "stone");
                    world[x+1][y]   = new Tile("demo/resources/", engine::int_vector_2d((x+1)*8, y*8), true, "stone");
                    world[x][y+1]   = new Tile("demo/resources/", engine::int_vector_2d(x*8, (y+1)*8), true, "stone");
                    world[x+1][y+1] = new Tile("demo/resources/", engine::int_vector_2d((x+1)*8, (y+1)*8), true, "stone");
                }
			}
		}
    }
